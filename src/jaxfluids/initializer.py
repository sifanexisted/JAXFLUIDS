...
class Initializer:
    ...
    def initialization(self, user_prime_init: Union[np.ndarray, jax.Array] = None) -> Dict[str, Dict[str, Union[jax.Array, float]]]:
        ...
        :type user_prime_init: Union[np.ndarray, jax.Array], optional
        :return: Dictionary of initial buffers
        :rtype: Dict[str, Dict[str, Union[jax.Array, float]]]
        """
