...
class OutputWriter:
    ...
    def write_output(self, buffer_dictionary: Dict[str, Dict[str, Union[jax.Array, float]]],
    ...
    def write_h5file(self, buffer_dictionary: Dict[str, Dict[str, jax.Array]]) -> None:
    ...
    def compute_real_buffer(self, buffer: jax.Array, volume_fraction: jax.Array) -> jax.Array:
    ...
    def compute_miscellaneous(self, primes: jax.Array, quantity: str, volume_fraction: Union[jax.Array, None]) -> jax.Array:
    ...
    @partial(jax.jit, static_argnums=(0))
    def compute_absolute_velocity(self, velocity: jax.Array) -> jax.Array:
        """Computes the absolute velocity field for h5 output.

        :param velocity: Buffer of velocities.
        :type velocity: jax.Array
    ...
    @partial(jax.jit, static_argnums=(0))
    def compute_mach_number(self, primes: jax.Array, volume_fraction: Union[jax.Array, None]) -> jax.Array:
    ...
    @partial(jax.jit, static_argnums=(0))
    def compute_vorticity(self, velocity: jax.Array) -> jax.Array:
    ...
    @partial(jax.jit, static_argnums=(0))
    def compute_absolute_vorticity(self, velocity: jax.Array) -> jax.Array:
