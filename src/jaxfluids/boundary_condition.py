...
class BoundaryCondition:
    ...
    def fill_boundary_primes(self, cons: jax.Array, primes: jax.Array,
            current_time: float) -> Tuple[jax.Array, jax.Array]:
    ...
    def fill_boundary_levelset(self, levelset: jax.Array) -> jax.Array:
    ...
    def fill_corners_levelset(self, levelset: jax.Array) -> jax.Array:
    ...
    def fill_corners_primes(self, primes: jax.Array) -> jax.Array:
    ...
    def wall(self, cons: jax.Array, primes: jax.Array, location: str,
            functions: Dict, current_time: float, b_range: List) -> Tuple[jax.Array, jax.Array]:
    ...
    def dirichlet(self, cons: jax.Array, primes: jax.Array, location: str,
            functions: Union[Callable, float], current_time: float, b_range: List) -> Tuple[jax.Array, jax.Array]:
    ...
    def neumann(self, cons: jax.Array, primes: jax.Array, location: str,
            functions: Union[Callable, float], current_time: float, b_range: List) -> Tuple[jax.Array, jax.Array]:
        """Fills the halo cells of the primitive and conservative variable buffer at the specified
    ...
    def symmetry(self, cons: jax.Array, primes: jax.Array,
            location: str, b_range: List) -> Tuple[jax.Array, jax.Array]:
    ...
    def periodic(self, cons: jax.Array, primes: jax.Array, location: str, b_range: List) -> Tuple[jax.Array, jax.Array]:
    ...
    def symmetry_levelset(self, levelset: jax.Array, location: str):
        slices_retrieve = self.slices_retrieve["symmetry"][location]
        slices_fill = self.slices_fill[location]
        levelset = levelset.at[slices_fill].set(levelset[slices_retrieve])
        return levelset
        
    def periodic_levelset(self, levelset: jax.Array, location: str):
        slices_retrieve = self.slices_retrieve["periodic"][location]
        slices_fill = self.slices_fill[location]
        levelset = levelset.at[slices_fill].set(levelset[slices_retrieve])
        return levelset