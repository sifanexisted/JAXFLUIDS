...
class LevelsetReinitializer:
    ...
    def reinitialize(self, levelset: jax.Array, mask_reinitialize: jax.Array,
            mask_residual: jax.Array, CFL: float, steps: int) -> Tuple[jax.Array, float]:
    ...
    def do_integration_step(self, levelset: jax.Array, levelset_0: jax.Array,
            mask: jax.Array, timestep_size: float) -> Tuple[jax.Array, jax.Array]:
    ...
    def compute_rhs(self, levelset: jax.Array, levelset_0: jax.Array,
