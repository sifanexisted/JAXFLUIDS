...
class LevelsetCreator:
    ...
    def get_circle(self, radius: float, position: List) -> jax.Array:
    ...
    def get_rectangle(self, length: float, position: List, height : float = None, radius: float = None) -> jax.Array:
    ...
    def get_sphere(self, radius: float, position: float) -> jax.Array:
    ...
    def create_levelset(self) -> jax.Array:
