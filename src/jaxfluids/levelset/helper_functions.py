...
def move_source_to_target_ii(source_array: jax.Array, normal_sign: jax.Array, axis: int) -> jax.Array:
    """Moves the source array in positive normal direction within the ii plane.

    :param source_array: Source array buffer
    :type source_array: jax.Array
    :param normal_sign: Normal sign buffer
    :type normal_sign: jax.Array
    :param axis: axis i
    :type axis: int
...
def move_source_to_target_ij(source_array: jax.Array, normal_sign: jax.Array, axis_i: int, axis_j: int) -> jax.Array:
...
def move_source_to_target_ijk(source_array: jax.Array, normal_sign: jax.Array) -> jax.Array:
...
def move_target_to_source_ii(target_array: jax.Array, normal_sign: jax.Array, axis: int) -> jax.Array:
    """Moves the target array in negative normal direction in the ii plane.

    :param target_array: Target array buffer
    :type target_array: jax.Array
    :param normal_sign: Normal sign buffer
    :type normal_sign: jax.Array
    :param axis: axis i
    :type axis: int
...
def move_target_to_source_ij(target_array: jax.Array, normal_sign: jax.Array, axis_i: int, axis_j: int) -> jax.Array:
...
def move_target_to_source_ijk(target_array: jax.Array, normal_sign: jax.Array) -> jax.Array:
