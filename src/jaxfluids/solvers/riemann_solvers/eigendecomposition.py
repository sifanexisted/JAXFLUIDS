...
class Eigendecomposition:
    ...
    def get_stencil_window(self, var: jax.Array, axis: int) -> jax.Array:
        return var[self.stencil_slices[axis]]

    def compute_frozen_state(self, primes: jax.Array, axis: int) -> jax.Array:
    ...
    def eigendecomp_prim(self, primes: jax.Array, axis: int) -> Tuple[jax.Array, jax.Array]:
    ...
    def _eigendecomp_cons(self, primes: jax.Array, axis: int) -> Union[Tuple[jax.Array, jax.Array], 
        ...
        :rtype: Union[Tuple[jax.Array, jax.Array], Tuple[jax.Array, jax.Array, jax.Array]]
        """
    ...
    def eigendecomp_cons(self, primes: jax.Array, axis: int) -> Union[Tuple[jax.Array, jax.Array], 
        Tuple[jax.Array, jax.Array, jax.Array]]:
        """Computes eigendecomposition of the Jacobian matrix for conservative variables.
    ...
    def transformtophysical(self, stencil: jax.Array, right_eig: jax.Array) -> jax.Array:
