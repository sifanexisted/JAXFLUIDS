...
class SourceTermSolver:
    ...
    def __init__(self, material_manager: MaterialManager, gravity: jax.Array, domain_information: DomainInformation, derivative_stencil_center: SpatialDerivative,
    ...
    def compute_gravity_forces(self, cons: jax.Array) -> jax.Array:
    ...
    def compute_heat_flux_xi(self, temperature: jax.Array, axis: int) -> jax.Array:
        """Computes the heat flux in axis direction.

        :param temperature: Buffer with temperature.
        :type temperature: jax.Array
    ...
    def compute_viscous_flux_xi(self, vels: jax.Array, temperature: jax.Array, axis: int) -> jax.Array:
    ...
    def compute_tau(self, vel_grad: jax.Array, dynamic_viscosity: jax.Array, 
        bulk_viscosity: jax.Array, axis: int) -> jax.Array:
    ...
    def compute_xi_derivatives_at_xj(self, prime: jax.Array, axis_i: int, axis_j: int) -> jax.Array:
