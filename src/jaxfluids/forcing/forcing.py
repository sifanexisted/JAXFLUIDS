...
class Forcing:
    ...
    def compute_forcings(self, primes: jax.Array, cons: jax.Array, levelset: Union[jax.Array, None],
        volume_fraction: Union[jax.Array, None], current_time: float, timestep_size: float, PID_e_new: float, PID_e_int: float,
        logger: Logger, primes_dash: Union[jax.Array, None] = None, **kwargs) -> Dict:
    ...
    def compute_temperature_forcing(self, primes: jax.Array, levelset: Union[jax.Array, None], volume_fraction: Union[jax.Array, None],
            current_time: float, timestep_size: float) -> Tuple[jax.Array, float]:
        """Computes temperature forcing.

        :param primes: Buffer of primitive variables.
        :type primes: jax.Array
        :param levelset: Buffer of level-set field.
        :type levelset: Union[jax.Array, None]
    ...
    @partial(jax.jit, static_argnums=(0))
    def compute_mass_flow_forcing(self, cons: jax.Array, primes: jax.Array, volume_fraction: Union[jax.Array, None],
        current_time: float, timestep_size: float, PID_e_new: float, PID_e_int: float) -> Tuple[jax.Array, float, float, float, float]:
        ...
        :rtype: Tuple[jax.Array, float, float]
        """
    ...
    @partial(jax.jit, static_argnums=(0))
    def compute_turb_hit_forcing(self, primes: jax.Array, primes_dash: jax.Array, timestep: float) -> jax.Array:
    ...
    def calculate_velocity_forcing_vector(self, vels: jax.Array, vels_dash: jax.Array, eta_s: int, timestep: float) -> jax.Array:
