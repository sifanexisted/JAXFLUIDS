...
class SimulationManager:
    ...
    def simulate(self, buffer_dictionary: Dict[str, Dict[str, Union[jax.Array, float]]]) -> None:
        ...
        :type buffer_dictionary: Dict[str, Dict[str, Union[jax.Array, float]]]
        """
        self.initialize(buffer_dictionary)
        self.advance(buffer_dictionary)

    def initialize(self, buffer_dictionary: Dict[str, Dict[str, Union[jax.Array, float]]]) -> None:
    ...
    def advance(self, buffer_dictionary: Dict[str, Dict[str, Union[jax.Array, float]]]) -> None:
    ...
    def do_integration_step(self, cons: jax.Array, primes: jax.Array, timestep_size: float, current_time: float,
        levelset: Union[jax.Array, None] = None, volume_fraction: Union[jax.Array, None] = None, apertures: Union[List, None] = None,
        ...
        :type levelset: Union[jax.Array, None], optional
        :param volume_fraction: Volume fraction buffer, defaults to None
        :type volume_fraction: Union[jax.Array, None], optional
    ...
    def compute_timestep(self, primes: jax.Array, levelset: jax.Array,
            volume_fraction: jax.Array, **kwargs) -> float:
    ...
    def _feed_forward(self, primes_init: jax.Array, levelset_init: jax.Array, n_steps: int, timestep_size: float,
        t_start: float, output_freq: int = 1, ml_parameters_dict: Union[Dict, None] = None,
        ml_networks_dict: Union[Dict, None] = None) -> Tuple[jax.Array, jax.Array]:
        ...
        :type primes_init: jax.Array
        :param levelset_init: Initial levelset buffer
        :type levelset_init: jax.Array
    ...
    def feed_forward(self, batch_primes_init: jax.Array, batch_levelset_init: jax.Array, n_steps: int, timestep_size: float,
        t_start: float, output_freq: int = 1, ml_parameters_dict: Union[Dict, None] = None, 
        ml_networks_dict: Union[Dict, None] = None) -> Tuple[jax.Array, jax.Array]:
        """Vectorized version of the _feed_forward() method.

        :param batch_primes_init: batch of initial primitive variable buffers
        :type batch_primes_init: jax.Array
        :param batch_levelset_init: batch of initial levelset buffers
        :type batch_levelset_init: jax.Array
