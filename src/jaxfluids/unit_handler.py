...
class UnitHandler:
    ...
    @partial(jax.jit, static_argnums=(0, 2))
    def dimensionalize(self, value: Union[jax.Array, float], quantity: str) -> Union[jax.Array, float]:
