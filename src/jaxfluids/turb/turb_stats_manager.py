...
class TurbStatsManager:
    ...
    def _get_real_wavenumber_grid(self, N: int) -> Tuple[jax.Array, jax.Array]:
    ...
    def energy_spectrum_spectral(self, velocity_hat: jax.Array) -> jax.Array:
    ...
    def energy_spectrum_physical(self, velocity: jax.Array) -> jax.Array:
        """Calculates the three-dimensional spectral energy spectrum of the input velocity.
    ...
    def get_turbulent_statistics(self, primes: jax.Array) -> Dict:
    ...
    def hit_statistics(self, primes: jax.Array) -> Dict:
    ...
    def calculate_vorticity_spectral(self, velocity_hat: jax.Array) -> jax.Array:
    ...
    def calculate_vorticity(self, velocity: jax.Array) -> jax.Array:
        """Calculates the vortiticy of the input velocity field. Calculation done in 
        spectral space.
    ...
    def calculate_sheartensor_spectral(self, velocity_hat: jax.Array) -> jax.Array:
    ...
    def calculate_sheartensor(self, velocity: jax.Array) -> jax.Array:
    ...
    def calculate_dilatation_spectral(self, velocity_hat: jax.Array) -> jax.Array:
    ...
    def calculate_dilatation(self, velocity: jax.Array) -> jax.Array:
        """_summary_
